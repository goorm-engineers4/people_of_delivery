...
class MenuRepositoryTest {
    ...
    void setUp() {
        ...
        // Factory를 활용한 메뉴 카테고리 생성
        menuCategory = Factory.createMockMenuCategory(); // "치킨류"
        entityManager.persistAndFlush(menuCategory);

        // Factory 스타일에 맞춘 메뉴 생성
        Menu menu1 = Menu.builder()
                .name("후라이드치킨") // Factory의 기본 메뉴명
                .content("기본 치킨")
                .price(18000)
